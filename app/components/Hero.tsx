    ...
    <div className="relative w-full min-h-[970px] bg-gradient-to-br from-blue-600 via-cyan-500 to-blue-400 animate-gradient-bg overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 md:pt-40 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 text-white">
          ...
          {/* Headline */}
          <h1 className="text-5xl md:text-7xl font-extrabold opacity-90 leading-tight tracking-tight">
          ...
          {/* CTA Input Group */}
          <div className="bg-white p-1.5 rounded-full max-w-md flex items-center shadow-2xl transform transition hover:scale-105 duration-300">
            ...
            <button className="bg-gray-900 text-white px-6 py-2 rounded-full font-medium flex items-center gap-2 hover:bg-gray-800 transition cursor-pointer">
